...
#pragma omp critical
        ...
        cv::Mat& cameraMatrix, cv::Mat& distortion, cv::Mat& rotation, cv::Mat& projection, std::vector<cv::Mat>& rvecs, std::vector<cv::Mat>& tvecs)
    {
        ...
        OUT_INFO("Camera Matrix:" << std::endl
                                  << cameraMatrix);
        OUT_INFO("Distortion Coeeficients:" << std::endl
                                            << distortion << std::endl);
    ...
    void calibrateExtrinsics()
    {
        ...
        OUT_INFO("Camera Matrix Color:" << std::endl
                                        << cameraMatrixColor);
        OUT_INFO("Distortion Coeeficients Color:" << std::endl
                                                  << distortionColor << std::endl);
        OUT_INFO("Camera Matrix Ir:" << std::endl
                                     << cameraMatrixIr);
        OUT_INFO("Distortion Coeeficients Ir:" << std::endl
        ...
        OUT_INFO("Rotation:" << std::endl
                             << rotation);
        OUT_INFO("Translation:" << std::endl
                                << translation);
        OUT_INFO("Essential:" << std::endl
                              << essential);
        OUT_INFO("Fundamental:" << std::endl
